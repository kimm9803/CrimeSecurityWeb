			            ...
			            <tbody>
			                <c:forEach var="myboard" items="${myboardList}">
			                    <tr>
			                        ...
			                        <td><a href="/board/updateform?nbnum=${myboard.bnum}" class="btn btn-warning">수정</a></td>
			                        <td><a href="/board/delete?nbnum=${myboard.bnum}" class="btn btn-danger">삭제</a></td>
			                    </tr>
			                </c:forEach>
			            </tbody>
			        </table>
